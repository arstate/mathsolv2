...
export const ApiKeyInput: React.FC<Props> = ({ onSave }) => {
  ...
  const handleCheckPermission = async () => {
    try {
        ...
        alert("✅ Izin Kamera Aktif!\n\nBrowser Anda sudah mengizinkan akses kamera.");
    } catch (err) {
        console.error(err);
        alert("⚠️ Izin Kamera Belum Diberikan.\n\nSilakan cek pengaturan situs di browser Anda (ikon gembok di url bar) dan pilih 'Izinkan' untuk Kamera.");
    }
  };
